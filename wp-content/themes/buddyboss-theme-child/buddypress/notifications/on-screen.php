...
if ( bp_has_notifications( $on_screen_notification_query_string ) ) :
	while ( bp_the_notifications() ) :
		bp_the_notification();
		?>
		<li testaaa class="read-item <?php echo isset( buddypress()->notifications->query_loop->notification->is_new ) && buddypress()->notifications->query_loop->notification->is_new ? 'unread' : ''; ?>">
