					...
					<div class="sub-menu">
						<div class="wrapper">
							<ul class="sub-menu-inner">
								...
								// $sfar_pub_user_details = \Safar\SafarPublications::api_request(["endpoint"=>"users/".$safar_publications_user_id."?test=".rand()]);

								if(!empty($safar_publications_user_id)){
									?>
									<li id="wp-admin-bar-my-subscriptions" class="menupop parent">
										<a class="ab-item" aria-haspopup="true" target="_blank" href="<?=site_url("?action=safarpublications_sso_login")?>">
											<i class="bb-icon-l bb-icon-money"></i>
											<span class="wp-admin-bar-arrow" aria-hidden="true"></span>My Subscriptions			
										</a>
									</li>
									<?php
								}
